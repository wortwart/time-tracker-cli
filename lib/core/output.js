...
exports.cliSuccess = exports.cliError = exports.outputVertical = exports.outputConfig = exports.summarize = undefined;
...
var summarize = exports.summarize = function summarize(search, tasks, rate, full, format) {
	...
	if (full) {
		...
		if (rate) table2.push({ 'Rate': [(0, _utils.calcRate)(rate, total)] });
