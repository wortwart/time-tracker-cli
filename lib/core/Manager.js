...
var Manager = function () {
	...
	_createClass(Manager, [{
		...
		key: 'summarize',
		value: function (_summarize) {
			function summarize(_x, _x2) {
				return _summarize.apply(this, arguments);
			}

			summarize.toString = function () {
				return _summarize.toString();
			};
		...
		value: function getStatus() {
			...
			Object.keys(this.tasks).forEach(function (key) {
				console.log(key, _this9.tasks[key].status, _this9.tasks[key].log[_this9.tasks[key].log.length - 1]);
			});
		}
	}]);
